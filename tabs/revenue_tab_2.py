...
# Define cohesive, muted palettes for professional look
MUTED_QUALITATIVE = [
    '#5478a6',  # steel blue
    '#8bb6d6',  # light blue
    '#a6c5ae',  # soft moss
    '#f6c28b',  # muted gold
    '#dbb2ff',  # lavender
    '#4173a6',  # deeper blue (replaces pale grey)
    '#e8d19e'   # sand
]

#MUTED_SEQUENTIAL = px.colors.sequential.Blues
...
def show_revenue_tab(filtered_df, palettes=None, show_kpi_cards_with_yoy_func=None):
    ...
    with col1:
        ...
        fig_region = px.bar(
            ...
            color_discrete_sequence=MUTED_QUALITATIVE, title=None)
